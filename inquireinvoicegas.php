    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-6 logo">
               <img src="layout/images/gas2.png" alt="bulb" class="img-responsive" style="margin-top:60px; height:550px">
            </div>
        </div>
    </div>
</div>
...
var xm=new XMLHttpRequest();
		...
		xm.open("GET","gascheck.php?ssid="+ssid,true);
		xm.send();	
		}
</script>
<?php
