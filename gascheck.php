...
if(strlen($ssid>0)){
$count=$db->getCount("select * from users , invoice where social_id=$ssid and service='g'  and U_id=(select ID from users where social_id=$ssid) ");

if($count >0){
	

//echo"<a href='gas.php?ssid=$ssid'>عرض الفاتورة</a>";	
	echo'
