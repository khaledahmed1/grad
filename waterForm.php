...
<body >
<nav class="navbar navbar-expand-sm bg-dark fixed-top" style="    height: 71px; margin-bottom: -24px;">
	<a class="navbar-brand" style="font-size: 50px; color: white" href="#">المياه</a>
  <ul class="navbar-nav">
    <li class="nav-item">
...
<br><br><br>
	...
	<div class="container-fluid">
       ...
       <img src="images/a11.jpg" class="mx-auto d-block" style="width:100%;height: 200px">
       
   
   
<!-- <?php echo "value='".$_SESSION['username']."'"; ?>-->
