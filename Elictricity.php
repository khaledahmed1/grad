...
<body class="form-v9">
	...
	<a class="navbar-brand" style="font-size: 50px; color: white" href="#">الكهرباء</a>
  <ul class="navbar-nav">
    <li class="nav-item">
      <a href="logout.php" class="logout" style="font-size: 26px; margin-left: 50px; ">تسجيل خروج <i class="fa fa-sign-out" aria-hidden="true"></i></a>
    </li>
...
<br><br><br>
	...
	<div class="container-fluid">
		<div class="row" >
       <img src="images/a7.jpg" class="mx-auto d-block" style="width:100%;height: 200px">
       
   
   


	<div class="page-content" style="background-color: #313954;">
		
		<div class="form-v9-content" style="background-image: url('images/a0.jpg')">
			...
			<form class="form-detail"  method="post">
				...
				<h2>الاشتراك في الكهرباء</h2>
				<div class="form-row-total">
					<div class="form-row">
						الاسم بالكامل<input type="text" name="full-name" id="full-name" class="input-text" placeholder="Your Name"
						 <?php echo "value='".$_SESSION['fullname']."'"; ?> required>
					</div>
					<div class="form-row">
						البريد الالكتروني<input type="text" name="your-email" id="your-email" class="input-text" placeholder="Your Email" required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}"  <?php echo "value='". $_SESSION['email']."'"; ?>>
					</div>
				</div>
				...
				<div class="form-row-total">
					...
					<div class="form-row">
						اسم المستخدم<input type="text" name="username" id="username" class="input-text"  <?php echo "value='".$_SESSION['username']."'"; ?> required>
					</div>
					<div class="form-row">
						رقم التليفون<input type="text" name="phone" id="phone" class="input-text" placeholder="Your Phone" <?php echo "value='".$_SESSION['phone']."'"; ?>required>
					</div>
				...
				<div class="form-row-total">
					<div class="form-row">
						...
						المحافظه<input type="text" name="Govern" id="Govern" class="input-text" placeholder="Your Govern" <?php echo "value='".$_SESSION['govern']."'"; ?>required>
					</div>
					<div class="form-row">
						الرقم القومي<input type="text" name="social_id" id="social_id" class="input-text" placeholder="Your Social Id" <?php echo "value='".$_SESSION['socialid']."'"; ?> required>
					</div>
				</div>
				<div class="form-row-total">
					<div class="form-row">
						الحي<input type="text" name="Center" id="Center" class="input-text" placeholder=" Center"  <?php echo "value='".$_SESSION['center']."'"; ?>required>
					</div>
				</div>
				<div class="form-row-total">
					<div class="form-row" >
